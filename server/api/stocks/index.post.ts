  ...
  if (existing) {
    ...
    const stmt = db.prepare(`
      INSERT INTO stocks (
        ...
        projected_margin, margin_mode, margin_y1, margin_y2, margin_y3, margin_y4, margin_y5, target_multiple, discount_rate, risk_spread,
    ...
    stmt.run(
      ...
      body.margin_mode ?? 'constant',
      body.margin_y1 ?? body.projected_margin ?? 0.20,
      body.margin_y2 ?? body.projected_margin ?? 0.20,
      body.margin_y3 ?? body.projected_margin ?? 0.20,
      body.margin_y4 ?? body.projected_margin ?? 0.20,
      body.margin_y5 ?? body.projected_margin ?? 0.20,
